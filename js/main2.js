/**
 * Created by valeriy.abornyev on 9/18/2015.
 */
...
var groupCollection = _.map(metadata.elements, function(model) {
    return model.group
});
...
var groupsCollection = new GroupCollection(groupCollection);

var groupView = new GroupsView({collection: groupsCollection});

$(document.body).append(groupView.render().el);
